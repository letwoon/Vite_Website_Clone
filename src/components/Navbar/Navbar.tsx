...
function Navbar({isOpen, setIsOpen} : NavbarProps) {
  ...
  return (
    <div>
      {/* Navbar */}
      <div
        className={`px-6 md:px-10  h-16 md:h-20 w-full border-b dark:border-white/10 dark:bg-dark_primary/30 border-black/10 bg-white/30 lg:border-0 flex justify-between items-center backdrop-blur-lg lg:fixed lg:top-0 lg:inset-x-0 z-50`}
      >
        <div className="flex justify-between w-full max-w-[1600px] mx-auto">
          ...
          {/* Desktop Nav */}
          <div
            className={`dark:text-white/90 text-midnight font-semibold text-left max-lg:hidden flex h-full`}
          >
            ...
            <div className="flex items-center relative">
              ...
              <div
                className={`dark:border-white/10 dark:bg-dark_primary border-black/10 bg-white px-2 py-3 absolute top-16 right-1 border  rounded-xl hidden peer-hover:flex hover:flex transition-all duration-500 w-40 flex-col  drop-shadow-lg z-30`}
              >
                <a
                  className={`py-2 px-3 mb-1 rounded-md dark:text-white/80 dark:hover:bg-dark_secondary text-midnight hover:bg-gray-100 hover:text-sky-500 text-sm `}
                  href="#"
                >
                  About Us
                </a>
        ...
        <div className="flex justify-end items-center w-4/5 lg:hidden">
          ...
          <button className="mr-8">
            <svg
              ...
              className={`fill-current dark:text-white/90 text-black/90 w-6 h-6`}
            >
      ...
      <div
        ...
        }  px-8 dark:bg-dark_primary bg-white transition-all duration-500 ease-in-out inset-x-0 z-40 fixed overflow-hidden `}
      >
        <div className="pt-6 pb-24 w-72 mx-auto">
          ...
          <div
            className={`dark:bg-dark_secondary bg-light_secondary rounded-lg h-12 mt-8 py-3 px-4 flex justify-between`}
          >
            <p
              className={`dark:text-white/50 text-black/50 text-sm  font-semibold`}
            >
              Appearance
            </p>
            <DarkmodeToggleButton />
          ...
          <div className="mt-8 flex justify-center h-9 items-center">
            <a href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`fill-current dark:text-white/60 dark:hover:text-white/90 text-black/60 hover:text-black/90 w-7 h-7 mx-2  hover:scale-105 transition-all duration-300`}
              >
